...
func CreateUser() http.HandlerFunc {
	return func(rw http.ResponseWriter, r *http.Request) {
		...
		// using the validator libarary to validate
		...
		if err != nil {
			...
			response := responses.UserResponse{Status: http.StatusInternalServerError, Message: "error in insertOne", Data: map[string]interface{}{"data": err.Error()}}
			json.NewEncoder(rw).Encode(response)
			return
		}
...
func GetAUser() http.HandlerFunc {
	return func(rw http.ResponseWriter, r *http.Request) {
		...
		response := responses.UserResponse{Status: http.StatusOK, Message: "successs", Data: map[string]interface{}{"data": user}}
...
func EditAUser() http.HandlerFunc {
	return func(rw http.ResponseWriter, r *http.Request) {
		...
		update := bson.M{"name": user.Name, "locaiton": user.Location, "title": user.Title}
